...
export declare const wrapResolver: ({ driver, config, nodes, relationships, schema, plugins, dbInfo }: WrapResolverArguments) => (next: any) => (root: any, args: any, context: Context, info: GraphQLResolveInfo) => Promise<any>;
