...
function translateDelete({ context, node }) {
    ...
    const topLevelMatch = (0, translate_top_level_match_1.translateTopLevelMatch)({ node, context, varName, operation: "DELETE" });
    ...
    const deleteQuery = new CypherBuilder.RawCypher((_env) => {
