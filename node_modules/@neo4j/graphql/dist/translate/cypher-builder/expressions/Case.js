...
class Case extends CypherASTNode_1.CypherASTNode {
    ...
    getCypher(env) {
        const comparatorStr = (0, utils_1.compileCypherIfExists)(this.comparator, env, { prefix: " " });
        const whenStr = this.whenClauses.map((c) => c.getCypher(env)).join("\n");
        const defaultStr = (0, utils_1.compileCypherIfExists)(this.default, env, { prefix: "\nELSE " });
